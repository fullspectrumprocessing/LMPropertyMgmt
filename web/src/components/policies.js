                ...
                <div className={styles.styledArticle}>
                    <div className={styles.styledDiv}>
                        <p className={styles.p}>
                            This privacy policy has been compiled to serve better those who are
                            ...
                            information that can be utilized on its own or with other information to
                            ...
                            <ul className={styles.ul}>
                                ...
                                <ul className={styles.ul}>
                                    ...
                                    <li>
                                        Telecommunication access devices including debit or credit
                                        card information; or
                                    </li>
                    ...
                    <div className={styles.styledDiv}>
                        ...
                        <p className={styles.p}>
                            LM Property Management obtains personal information in the following
                            ways:
                            <ul className={styles.ul}>
                            <li>
                                In consumer reports from reporting agencies to which this company
                            ...
                            <li>
                                In other real estate related forms the customer or client completes
                                in or related to a transaction; and
                            </li>
                            <li>
                                In tax reporting forms that the customer or client is required to
                    ...
                    <div className={styles.styledDiv}>
                        ...
                        <p className={styles.p}>
                            ...
                            reporting agencies and uses personal information to complete those
                            reports. convey personal information he or she provides to the agent to
                            service providers (for example, mortgage lenders and title companies) as
                            those service providers may require for the products or services the
                            client needs or requests. If this company represents a prospective
                            tenant in a lease transaction, the personal information may, on the
                            tenant’s behalf and with the tenant’s knowledge, be discussed with and
                            provided to landlords or their agents. This company and its agents
                            exercise reasonable discretion when discussing any personal information
                            with others.
                        </p>
                        <br></br>
                        <p className={styles.p}>
                    ...
                    company acts as a property manager for a property owner; the company uses the
                    property owner’s personal information only: (a) to deliver the required
                    management services; (b) to file any required reports with governmental agencies
                    (for example, the IRS); (c) to establish ACH deposits, or (d) for other purposes
                    the property owner may authorize, such as providing utilities.
                </p>
            <br></br>
                <p className={styles.p}>
                    Personal Information from Clients: When this company represents a person (buyer,
                    seller, landlord or tenant) in a transaction the agent servicing the client may,
                    on the client’s behalf and at the client’s instruction,
                </p>
                    </div>{' '}
                    ...
                    <div className={styles.styledDiv}>
                        <h2 className={styles.h2}> How do we protect visitor information?</h2>
                        <p className={styles.p}>
...
<br></br>
                        ...
                        <p className={styles.p}>
                            ...
                            discussing any personal information with others and release personal
                            information to others only as described by this policy.
                        </p>
                        <br></br>
                        <p className={styles.p}>
                            This company does not permit its employees or agents to make copies of
                            consumer reports or records of insurance claims. The consumer reports
                            retained in the company’s files are not to be accessed in the future as
                            a convenience to customers or clients.
                        </p>
                        <br></br>
                        <p className={styles.p}>
                            The individual agents that work with this company are independent
                            contractors and the agent with whom a customer or client works with may
                            maintain a separate transaction file.
                        </p>
                        <br></br>
                        <p className={styles.p}>
                            The company instructs its agents to not permit other persons to access
                            the personal information in files the agents maintain. The company
                            instructs its agents to protect the personal information in the agent's’
                            files in the same manner as described in this policy.
                        </p>
                        <br></br>
                        <p className={styles.p}>
                            ...
                            confidential. Also, all sensitive/credit information you supply is
                        ...
                        <br></br>
                        <p className={styles.p}>
                            For your convenience, we may store your credit card information kept for
                            more than 60 days to expedite future orders, and to automate the billing
                            process.
                        </p>
                    </div>
                    <div className={styles.styledDiv}>
                        <h2 className={styles.h2}>Third Party Disclosure</h2>
                        <p className={styles.p}>
                            We do not sell, trade, or otherwise transfer to outside parties your
                            personally identifiable information unless we provide you with notice or
                            the party is a direct affiliate. This does not include website hosting
                    ...
                    <div className={styles.styledDiv}>
                        <h2 className={styles.h2}>Access to Personal Information?</h2>
                        <p className={styles.p}>
                        ...
                        <ul className={styles.ul}>
                            <li>
                                The agent or broker who is servicing or coordinating the
                                transaction;
                            </li>
                            <li>
                                The office manager to whom the agent reports; and Property Manager,
                                Assistant Property Manager, and Receptionists.
                            </li>
                            <li>Application processors;</li>
                            <li>
                                Employees who need to access the information to assists agents,
                                brokers, accountants, office manager in processing or performing a
                                task.
                            </li>
                        </ul>
                        <p className={styles.p}>
                            Personal information from a buyer, seller, landlord, or tenant may be
                            discussed with others (such as mortgage lenders or prospective
                            landlords) only as is reasonably necessary to negotiate or close the
                            transaction or to provide the services the customer or client seeks from
                            this company.
                        </p>
                        <br></br>
                        <p className={styles.p}>
                            This company may, at the customer’s or client’s request, provide
                            personal information to service providers in a transaction such as a
                            title company or mortgage company if it is necessary to expedite or
                            complete a transaction.
                        </p>
                        <br></br>
                        <p className={styles.p}>
                            If the company is required by law to allow others to access the personal
                            information in the company’s files, the company will comply with the law
                            (for example, compliance with court orders, subpoenas, or governmental
                    ...
                    <div className={styles.styledDiv}>
                        <h2 className={styles.h2}>Disposal of Personal Information</h2>
                        <p className={styles.p}>
                            ...
                            documents, erasing electronic files by means that make the files
                            unreadable or undecipherable, or by eradicating personal information
                            from documents or electronic files in ways that make the personal
                            information Unreadable.
                        </p>
                    </div>
                    <div className={styles.styledDiv}>
                        <h2 className={styles.h2}>Erroneous Records:</h2>
                        <p className={styles.p}>
                            ...
                            records and request the reporting agency to correct the information in
                            its records promptly after the company has learned and determined that
                        ...
                        <p className={styles.p}>
                            ...
                            stating that the dishonored check was not authorized. Notice: This
                            Company asks any person who provides personal information to this
                            company or one of its agents to identify the information at that time as
                            “personal information.”
                        </p>
                    </div>
                    <div className={styles.styledDiv}>
                        <h2 className={styles.h2}>We collect your email address to:</h2>
                        <ul className={styles.ul}>
                            <li>
                    ...
                    <div className={styles.styledDiv}>
                        ...
                        <p className={styles.p}>
                            ...
                            <ul className={styles.ul}>
                                <li>By email: info@LMPropertyMgmt.com</li>
                            </ul>
                        </p>
                    </div>
                </div>
